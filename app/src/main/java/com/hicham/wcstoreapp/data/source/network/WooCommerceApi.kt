...
class FakeWooCommerceApi(private val json: Json): WooCommerceApi {
    override suspend fun getProducts(pageSize: Int, offset: Int): List<NetworkProduct> {
        val productsJson = """[
    {
        "id": 61,
...
"""
        return json.decodeFromString(ListSerializer(NetworkProduct.serializer()), productsJson)
    }
}